...
IOTA_IMPORT(_iota_grab_input)
int _iota_grab_input(int mode);
IOTA_IMPORT(_iota_warp_cursor)
void _iota_warp_cursor(int x, int y);
IOTA_IMPORT(_iota_show_cursor)
void _iota_show_cursor(int toggle);
