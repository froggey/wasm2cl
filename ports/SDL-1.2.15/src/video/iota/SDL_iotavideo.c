...
IOTA_IMPORT(_iota_set_caption)
void _iota_set_caption(const char *title, const char *icon);
...
IOTA_IMPORT(_iota_video_init)
int _iota_video_init(void);
IOTA_IMPORT(_iota_video_quit)
void _iota_video_quit(void);
IOTA_IMPORT(_iota_set_video_mode)
int _iota_set_video_mode(int width, int height);
IOTA_IMPORT(_iota_video_update)
void _iota_video_update(void *pixbuf);
